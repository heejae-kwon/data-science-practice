...
def run_PCA():
    data_path = Path(str(Path.cwd())+'/chap03/data/credit_card.csv')
    ...
    db_default: DBSCAN = DBSCAN(eps=0.0375, min_samples=3).fit(X_principal)
    ...
    # 모델 튜닝
    db: DBSCAN = DBSCAN(eps=0.0375, min_samples=50).fit(X_principal)
    labels1 = db.labels_
    ...
    r = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[0])
    g = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[1])
    b = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[2])
    c = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[3])
    y = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[4])
    m = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[5])
    k = plt.scatter(X_principal['P1'], X_principal['P2'],
                    marker='o', color=colours1[-1])

    plt.figure(figsize=(9, 9))
    plt.scatter(X_principal['P1'], X_principal['P2'], c=cvec)
    plt.legend((r, g, b, c, y, m, k), ('Label 0', 'Label 1', 'Label 2',
               'Label 3', 'Label 4', 'Label 5', 'Label -1'), scatterpoints=1, loc='upper left', ncol=3, fontsize=8)
    plt.show()
